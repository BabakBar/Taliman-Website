...
export const ui = {
  fa: {
    ...
    'about.feature3.description': 'بیش از ۲۰ سال تجربه در صنعت فلز',
    'about.feature4.title': 'خدمات سفارشی',
    'about.feature4.description': 'تولید مطابق نیاز مشتری و مشاوره تخصصی',
    ...
    'quality.subtitle': 'تعهد به برترین استانداردهای جهانی',
    'contact.title': 'تماس با ما',
    'contact.subtitle': 'با کارشناسان ما در ارتباط باشید',
  ...
  en: {
    ...
    'about.subtitle':
      'With over two decades of experience in steel wire processing, Taliman Sakhtehaye Felezi Kara delivers premium quality products for automotive and manufacturing industries using state-of-the-art equipment and international quality standards.',
    'about.feature1.title': 'Advanced Equipment',
    ...
    'processes.annealing.description':
      'Specialized heat treatment to enhance wire mechanical properties',
    'processes.drawing.title': 'Wire Drawing',
